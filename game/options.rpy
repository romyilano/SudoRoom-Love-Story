...
init -1 python hide:
    ...
    config.window_title = u"SudoRoom: a Love Story"

    # These control the name and version of the game, that are reported
    # with tracebacks and other debugging logs.
    config.name = "SudoRoom: a Love Story"
    config.version = "0.0"
    ...
    theme.bordered(
        ...
        mm_root = "images/backgrounds/startpage.png",
...
python early:
    config.save_directory = "SudoRoom: a Love Story-1390591801"
